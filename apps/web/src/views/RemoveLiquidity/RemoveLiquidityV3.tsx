        ...
        <CardBody>
          <AutoRow justifyContent="space-between" mb="24px">
            ...
            <Flex>
              ...
              {liquidityValue0 && liquidityValue1 ? (
                <RangeTag removed={removed} outOfRange={outOfRange} outline />
              ) : null}
            </Flex>
          </AutoRow>
          ...
          <EBox style={{ padding: '20px' }}>
            ...
            <Slider
              ...
              mb="16px"
            />
            <Flex flexWrap="wrap" justifyContent="space-evenly" style={{ gap: 8 }}>
              <EButtonSm style={{ flexGrow: 1, maxWidth: '100px' }} onClick={() => onPercentSelect(25)}>
                25%
              </EButtonSm>
              <EButtonSm style={{ flexGrow: 1, maxWidth: '100px' }} onClick={() => onPercentSelect(50)}>
                50%
              </EButtonSm>
              <EButtonSm style={{ flexGrow: 1, maxWidth: '100px' }} onClick={() => onPercentSelect(75)}>
                75%
              </EButtonSm>
              <EButtonSm style={{ flexGrow: 1, maxWidth: '100px' }} onClick={() => onPercentSelect(100)}>
                {t('MAX')}
              </EButtonSm>
            </Flex>
          </EBox>
