  ...
  return (
    <Card isActive mb={['24px', '24px', '24px', '0']}>
      <Box padding={16}>
            ...
            <BenefitsTooltipsText
              ...
              tooltipComponent={
                <>
                  ...
                  <NextLinkFromReactRouter
                    target="_blank"
                    to="https://docs.flack.exchange/products/revenue-sharing/faq#50b7c683-feb0-47f6-809f-39c1a0976bb5"
                  >
        ...
        <LinkExternal external m="8px auto auto auto" href="https://docs.flack.exchange/products/revenue-sharing">
          {t('Learn More')}
        </LinkExternal>
      </Box>
    </Card>
