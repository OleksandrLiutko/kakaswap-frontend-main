...
export const PANCAKE_EXTENDED = 'https://tokens.flack.exchange/pancakeswap-extended.json'

const COINGECKO = 'https://tokens.flack.exchange/coingecko.json'
const PANCAKE_ETH_DEFAULT = 'https://tokens.flack.exchange/pancakeswap-eth-default.json'
const PANCAKE_ZKSYNC_DEFAULT = 'https://tokens.flack.exchange/pancakeswap-zksync-default.json'
const PANCAKE_POLYGON_ZKEVM_DEFAULT = 'https://tokens.flack.exchange/pancakeswap-polygon-zkevm-default.json'
const PANCAKE_ARB_DEFAULT = 'https://tokens.flack.exchange/pancakeswap-arbitrum-default.json'
const PANCAKE_LINEA_DEFAULT = 'https://tokens.flack.exchange/pancakeswap-linea-default.json'
const PANCAKE_BASE_DEFAULT = 'https://tokens.flack.exchange/pancakeswap-base-default.json'
const PANCAKE_OPBNB_DEFAULT = 'https://tokens.flack.exchange/pancakeswap-opbnb-default.json'

export const PANCAKE_ETH_MM = 'https://tokens.flack.exchange/pancakeswap-eth-mm.json'
export const PANCAKE_BSC_MM = 'https://tokens.flack.exchange/pancakeswap-bnb-mm.json'

const COINGECKO_ETH = 'https://tokens.coingecko.com/uniswap/all.json'
// export const CMC = 'https://tokens.flack.exchange/cmc.json' // not updated for a while
