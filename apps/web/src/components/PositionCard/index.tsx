      ...
      {userPoolBalance && userPoolBalance.quotient > BIG_INT_ZERO ? (
        ...
        <LightCard>
          <Text fontSize="14px" style={{ textAlign: 'center' }}>
            ...
            {isStableLP ? (
              <>
                By adding liquidity, you’ll earn 50% from the fees of all trades on this pair, proportional to your
                share in the trading pair. Fees are added to the pair, accrue in real time, and can be claimed by
                withdrawing your liquidity. For more information on Stableswap fees click,
                <Link
                  style={{ display: 'inline' }}
                  ml="4px"
                  external
                  href="https://docs.flack.exchange/products/stableswap#stableswap-fees"
                >
                  {t('here.')}
                </Link>
              </>
              ...
              <>
                By adding liquidity you'll earn 0.17% of all trades on this pair proportional to your share in the
                trading pair. Fees are added to the pair, accrue in real time and can be claimed by withdrawing your
                liquidity.,
              </>
            )}
          </Text>
