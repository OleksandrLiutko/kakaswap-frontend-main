...
export const MIXED_ROUTE_QUOTER_ADDRESSES = {
  ...
  [ChainId.BLOCKSPOT_TESTNET]: '0x507A6c059b8A7e5376De580C4c1916A9Cb26B443',
...
export const V3_QUOTER_ADDRESSES = {
  ...
  [ChainId.BLOCKSPOT_TESTNET]: '0x507A6c059b8A7e5376De580C4c1916A9Cb26B443', // from v3 periphery
} as const satisfies Record<ChainId, Address>
