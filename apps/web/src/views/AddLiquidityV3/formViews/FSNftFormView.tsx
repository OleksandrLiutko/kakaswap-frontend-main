...
import { FSNftLPChildrenProps } from 'views/AddLiquidity/AddFSNftLiquidity'
...
export default function FSNftFormView({
  formattedAmounts,
  addIsUnsupported,
  addIsWarning,
  ...
  return (
    <>
      ...
      <HideMedium>
        {nftPool && buttons}
        {!nftPool && (
          <Button width="100%" onClick={onCreateNftPool} disabled={createNftDisabled}>
            Initialize
          </Button>
        )}
      </HideMedium>
