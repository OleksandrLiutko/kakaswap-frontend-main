              ...
              <Flex justifyContent="space-between" flexDirection={['column', 'column', 'column', 'row']}>
                <Flex flexDirection="column" mb={['8px', null]}>
                  <Flex alignItems="center">
                    <CurrencyLogo size="20px" address={address} chainName={chainName} />
                    <Text ml="12px" bold lineHeight="0.7" fontSize={'20px'} id="info-token-name-title">
            ...
            <ContentLayout>
              <EBox>
                <Box p="24px">
                  ...
                  <Text bold fontSize="20px" textTransform="uppercase">
