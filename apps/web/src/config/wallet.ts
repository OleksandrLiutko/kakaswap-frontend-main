  ...
  return [
    {
      ...
      deepLink: 'https://metamask.app.link/dapp/flack.exchange/',
      qrCode,
      downloadLink: 'https://metamask.app.link/dapp/flack.exchange/',
    },
    {
      id: 'binance',
    ...
    },
    {
      ...
      deepLink: 'https://link.trustwallet.com/open_url?coin_id=20000714&url=https://flack.exchange/',
...
export const getDocLink = (code: string) =>
  docLangCodeMapping[code]
    ? `https://docs.flack.exchange/v/${docLangCodeMapping[code]}/get-started/wallet-guide`
    : `https://docs.flack.exchange/get-started/wallet-guide`
