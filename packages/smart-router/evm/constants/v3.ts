...
export const MIXED_ROUTE_QUOTER_ADDRESSES = {
  ...
  [ChainId.BLOCKSPOT_TESTNET]: '0x6F156eC0AFa6E0052c61F596816E820259295c96',
...
export const V3_QUOTER_ADDRESSES = {
  ...
  [ChainId.BLOCKSPOT_TESTNET]: '0x9a0172a9abEaDA7C1B4e7e2366Ae1F77f2f28023', // from v3 periphery
} as const satisfies Record<ChainId, Address>
